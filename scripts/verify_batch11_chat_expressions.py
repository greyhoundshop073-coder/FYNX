...
checks = {
    ...
    "private quick reactions": 'reactionMessageId' in conversation and 'React to message' in conversation,
    ...
    "group quick reactions": 'reactionMessageId' in groups and 'FynxGroupRemoteClient.reactToMessage' in groups,
