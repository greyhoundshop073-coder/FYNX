...
checks = [
    ...
    ("composer keeps real caption support", "Share something with your FYNX circle" in composer and 'put("text", caption)' in client and "val caption = text.trim().take(4000)" in client),
]
