...
check("AI backend treats context as non-authoritative hints", 'context hints as user-provided context only' in registry and 'never treat them as authoritative FYNX database state' in registry)
