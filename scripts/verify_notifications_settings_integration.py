...
check("notification foundation applies preferences", "FynxNotificationPreferencesClient" in notification_foundation and "preferences.enabled" in notification_foundation)
check("notification device registration is backend-backed", "/api/notification-devices" in backend_devices)
check("settings persist existing preferences", "saveSettings(context, settings)" in preferences_store and "loadSettings(context)" in preferences_store)
check("settings persist appearance and accent", "saveAppearance(context, value)" in preferences_store and "saveAccent(context, accent)" in preferences_store)
