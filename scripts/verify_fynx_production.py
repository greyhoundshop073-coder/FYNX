...
check("bottom navigation preserves the existing primary destinations", 'FynxNavItem("Home", "Home", Icons.Default.Home)' in app and 'FynxNavItem("Chats", "Chat", Icons.Default.ChatBubbleOutline)' in app and 'FynxNavItem("Friends", "Friends", Icons.Default.Person)' in app and 'FynxNavItem("Marketplace", "Market", Icons.Default.ShoppingBag)' in app and 'FynxNavItem("Features", "More", Icons.Default.MoreHoriz)' in app)
check("business and money tools remain reachable through the existing features area", '"Business Account" -> FynxBusinessAccountPanel' in app and '"Money Tools" -> MoneyCenterPanel()' in app and 'Triple("Money Tools", "Money Center"' in app)
