...
check("bottom navigation uses the compact primary navigation", 'FynxNavItem("Home", "Home", Icons.Default.Home)' in app and 'FynxNavItem("Chats", "Chat", Icons.Default.ChatBubbleOutline)' in app and 'FynxNavItem("Friends", "Friends", Icons.Default.Person)' in app and 'FynxNavItem("Stories", "Stories", Icons.Default.AutoStories)' in app and 'FynxNavItem("Features", "More", Icons.Default.MoreHoriz)' in app)
check("marketplace, business and money tools remain reachable outside the primary bottom bar", 'Triple("Marketplace", "Marketplace", Icons.Default.ShoppingBag)' in app and '"Business Account" -> FynxBusinessAccountPanel' in app and '"Money Tools" -> MoneyCenterPanel()' in app and 'Triple("Money Tools", "Money Center"' in app)
