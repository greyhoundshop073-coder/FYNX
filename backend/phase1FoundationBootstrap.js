...
const helperStart = "const fynxRealtimeMessagingCanSend = async (senderId, targetId) => {";
const helperEnd = "const fynxRealtimeMessagingTypingTarget";
...
if (helperStartIndex < 0 || helperEndIndex < 0) {
