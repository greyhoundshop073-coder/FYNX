...
async function installHomeCommentBackend() {
  ...
  // Match the schema marker produced by the authoritative social-core builder.
  // That builder uses no space after the comma in (post_id,created_at ASC).
