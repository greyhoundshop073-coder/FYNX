...
fun FynxGroupMediaPicker(
    ...
    val launcher = rememberLauncherForActivityResult(ActivityResultContracts.GetContent()) { uri ->
        ...
        scope.launch {
            ...
            val result = FynxProductionMessaging.uploadMedia(context, uri, mime.ifBlank { null })
    ...
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
        IconButton(enabled = !uploading, onClick = { launcher.launch("image/*") }) {
...
fun createGroupMediaMessage(uri: Uri, type: String = "image"): ChatMessage = ChatMessage(
    text = if (type == "video") "Video" else "Photo",
    fromMe = true,
