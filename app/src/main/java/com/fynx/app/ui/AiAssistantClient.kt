...
object AiAssistantClient {
    ...
    suspend fun createProductMarketingCopy(context: Context, productName: String, category: String, condition: String, sellerFacts: String, hasMedia: Boolean, mediaCount: Int): Result<String> {
